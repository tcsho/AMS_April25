...
/// </summary>
public class BLLResetLeavesEmployeewise
{
    public BLLResetLeavesEmployeewise()
    {
        //
    ...
    _DALResetLeavesEmployeewise objDAL = new _DALResetLeavesEmployeewise();
    ...
    public DataTable FetchLeavesEmployeewise(BLLResetLeavesEmployeewise objBll)
    {
        return objDAL.FetchLeavesEmployeewise(objBll);
    }


    public int ResetEmployeeLeaves(BLLResetLeavesEmployeewise objBll)
    {
