...
public class DALBase
{
    ...
    static DALBase()
    {
        strConnect = Convert.ToString(System.Configuration.ConfigurationManager.ConnectionStrings["tcs_invConnectionString"]);
    }
    ...
    public int sqlcmdExecuteByOutPut(string procedurename, SqlParameter[] param)
    {
        int IntReturnValue = 0;
        SqlCommand cmd = new SqlCommand(procedurename, _cn) { CommandType = CommandType.StoredProcedure };
        try
        {
            cmd.Parameters.Add(new SqlParameter("@ReturnValue", SqlDbType.Int, 4, ParameterDirection.ReturnValue, false, 0, 0, "", DataRowVersion.Proposed, 0));
